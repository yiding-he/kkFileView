...
public class OfficeFilePreviewImpl implements FilePreview {
  ...
  public String filePreviewHandle(String url, Model model, FileAttribute fileAttribute) {
    ...
    if (
      ...
      if (response.isFailure()) {
        log.info("文件下载失败, code={}, message={}", response.getCode(), response.getMsg());
        return otherFilePreview.notSupportedFile(model, fileAttribute, response.getMsg());
      }
      log.info("文件下载结果 success={}", response.isSuccess());
    ...
    if (!isHtmlView &&  (
      OFFICE_PREVIEW_TYPE_IMAGE.equals(officePreviewType) || OFFICE_PREVIEW_TYPE_ALL_IMAGES.equals(officePreviewType)
    )) {
      return getPreviewType(
        model, fileAttribute, officePreviewType, cacheName, outFilePath,
  ...
  static String getPreviewType(
    Model model, FileAttribute fileAttribute, String officePreviewType,
    String pdfName, String outFilePath,
    FileHandlerService fileHandlerService, String officePreviewTypeImage,
